function[ywJudgedResult,ywAfterShockIndex,ywBGIndex]=ywDelauny2_CutRelationShip2(tri,dis12,dis23,dis13,dis14,dis24,dis34,x,y,z,D,ywDraw)
    ...
    % % %     ywJudgedResult=aa;
    %-%-%----------------------------------------------------------------------------------------------------------------
    % % %     %按照三角形进行截取,以四面体为研究对象，如果本四面体中某条边存在超过阈值，则删除本四面体。
    newTri=tri;
    Lc=D;
    m12=find(dis12>=Lc);
    newTri(m12,:)=nan;
